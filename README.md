...
터미널 사용이 익숙하지 않은 사용자도 한 줄 명령으로 필요한 개발 환경과 AI CLI 도구를 설치할 수 있도록 구성했습니다.
...
CLI Installer는 아래 환경 구성을 자동으로 진행합니다.
...
설치가 시작되면 필요한 개발 도구 설치 후 AI CLI 선택 화면이 표시됩니다.
...
동일한 구조로 새로운 CLI 도구를 쉽게 확장할 수 있습니다.
